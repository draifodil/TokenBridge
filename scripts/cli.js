...
const contractABI = require("../artifacts/contracts/Tokenbridge.sol/Tokenbridge.json").abi;

program
    .name("tokenbridge-cli")
    .description("CLI tool for Tokenbridge smart contract")
    .version("1.0.0");
